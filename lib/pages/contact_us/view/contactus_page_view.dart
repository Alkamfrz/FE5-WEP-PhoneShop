import 'package:phones_shop/configs/configs.dart';
import 'package:phones_shop/pages/contact_us/view_model/contactus_page_view_model.dart';
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          InkWell(
                            onTap: () {
                              url_launcher.launchUrl(Uri.parse("mailto:alkamfrz@gmail.com"));
                            },
                            child: Container(
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(15.0),
                                  color: const Color(0xff7c471c)),
                          ...
                          InkWell(
                            onTap: () {
                              url_launcher.launchUrl(Uri.parse("tel://6281316882041"));
                            },
                            child: Container(
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(15.0),
